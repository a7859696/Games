...
public class GameUtil {
    ...
    public static void getPuzzleGenerator() {
        int index = 0;
        // 随机打乱顺序
       // Log.d("ImagesUtil", "mBlankItemBean的第一次：" + mBlankItemBean.getBitmap());
        //Log.d("ImagesUtil","mBlankItemBean的第一次："+mBlankItemBean.getBitmapId());
...
/*        for (int i=0;i<mItemBeans.size();i++){
            if (mItemBeans.get(i).getBitmap()==null){
                Log.d("ImagesUtil","getPuzzleGenerator方法里面的 mItemBeans:  "+i);
            }
        }*/
